...
##cloudflare配置
#cloudflare账号邮箱
x_email=gfsmelt@gmail.com
#填写需要DDNS的完整域名
#支持多域名:域名需要填写在括号中，每个域名之间用“空格”相隔。
#例如：（cdn.test.com） 或者 （cdn1.test.com cdn2.test.com cdn3.test.com）
hostname=(v2.shiyanfei.cloudns.org)
#空间ID
zone_id=caa45bc0cca7558b9543f0bf63597ae9
#Global API Key
api_key=dc5343245857a934b745380542a7b894ccf33
###################################################################################################
##openwrt科学上网插件配置
...
##CloudflareST配置
#测速地址  
CFST_URL=cesu.shiyanfei.clouddns.org
